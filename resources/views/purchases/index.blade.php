...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h4 class="title">Lista das Notas de Entrada
                        <a style="position: relative;float: right;"
                           href="{{ route('purchases.create') }}"><buttom class="btn btn-success">Novo</buttom></a>
                    </h4>
                        ...
                        @foreach ($purchases as $purchase)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('purchases.destroy', ['purchase' => $purchase->id])}}"
                                       class="btn-danger btn-sm"
                                       onclick="event.preventDefault();document.getElementById('{{$deleteform}}').submit();">
                                        <i class="fa fa-close"></i></a>
                                    {!! Form::open(['route'  => ['purchases.destroy', '$purchase' => $purchase],
                                                    'method' => 'DELETE',
                                                    'id'     => $deleteform,
                                                    'style'  => 'display:none']) !!}
                                    {!! Form::close() !!}
